...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `check_textid` CHECK (regexp_like(`textid`,_utf8mb4'^2[0-9]{8}$'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comments` VALUES ('000000001','100000002','200000001','谢谢钢铁猪猪侠送来的钢铁棒棒糖！','2024-03-22 14:25:06'),('000000002','100000001','200000002','哇真的是你呀，下次一定要继续玩。','2024-03-22 14:20:06'),('000000006','100000002','200000003','这是一个测试','2024-05-12 10:51:39'),('000000003','100000001','200000004','是你们啊','2024-05-19 11:28:37'),('000000003','100000006','200000005','是你们啊1','2024-05-19 11:28:37'),('000000003','100000006','200000006','是你们啊2','2024-05-19 11:28:37'),('000000003','100000006','200000007','是你们啊3','2024-05-19 11:28:37');
...
INSERT INTO `django_session` VALUES ('6sf86gsy6ptotwyt532p2q538t0j5cjc','e30:1s12Fw:7Zxw7klfGtpoyqMfxNbeVHwlWcSH7lFufv06UmQcBaw','2024-05-12 10:59:40.729125'),('7rji8mcjdhxb6j1kf4slavaqbx3su5lj','.eJyrViotTi2Kz0xRslIygAJDJR2waF5ibipQOKbUzDTVAESaJANJsySTmFLLNEtLINvI0CKm1NQiNUmpFgAalRWl:1s9O0x:x-ZrOIpERvxCMZwjs2Vg-PEsPOG7f5MLiPfZ3PtfVFg','2024-06-04 11:50:43.731276'),('81uykbxrpdjokmraoqj5gc337sx71v9m','e30:1s11X6:29uu0GRk71YVatMls4WWoAY3M_OyQ_eTWaekg8qByAs','2024-05-12 10:13:20.311229'),('95c358a51safnoqczju0e07pjs7vdesd','eyJ1c2VybmFtZSI6InRlc3QifQ:1s12Dy:-5ljgQ0SxRqy8iF6da3L_dvr6EKgy7_u8WvCuKdbUUs','2024-05-12 10:57:38.236759'),('gjux3icm0n95sd4aonh056k3a4mgv93f','e30:1s11Rk:OUYQQQSZFmW3JldPcTq9clnod1tdpHUsFDlclsAAiLM','2024-05-12 10:07:48.828730'),('l5vd7mfzjzk80kvbgkfoogn8t09l90t8','e30:1s11Tx:UQAC55gQ2qANME3Cz5T-AUlxjAz17VNGayGN-nXuYto','2024-05-12 10:10:05.552416'),('rwk9hijbo1b864rlv5d2epw55o50kb4m','.eJyrViotTi2Kz0xRslIygAJDJR2waF5ibipQOKbUzDTVAESaJANJsySTmFLLNEtLINvI0CKm1NQiNQmoA8UIC6AAVHtJanGJUi0AInwdZw:1s9OgA:v0MU5GVKGYSKOZ-69GQ150gRZbejXEnXimqDJ1CBQOo','2024-06-04 12:33:18.945090'),('unnu5jvgccf897fh28jdcywfqs6y1hwb','e30:1s11MZ:Usle83qBiwarn7zZS9Ol3VJ7HG3xVczvupBTfanQCRw','2024-05-12 10:02:27.605428');
...
INSERT INTO `user` VALUES ('000000010','test1','','empty/empty.jpg'),('000000008','test','this is a test.','user/empty/empty.jpg'),('000000007','LiLingzhee',NULL,'user/empty/empty.jpg'),('000000006','热情火箭人','烈火燃烧，燃尽一切阻碍','user/photo/rqphoto.jpg'),('000000005','雷霆忍者','闪电迅雷，刀刃无声','user/photo/rtphoto.jpg'),('000000004','寒冰射手','一颗冰蓝色的豌豆','user/photo/bsnsgphoto.jpg'),('000000003','火焰小子','烈火燃烧，无所畏惧','user/photo/hyxzphoto.jpg'),('000000002','钢铁猪猪侠','jjb超级变身','user/photo/zzxphoto.jpg'),('000000001','无敌暴龙战士','暴龙战士，无所畏惧！','user/photo/myphoto.jpg'),('000000000','admin',NULL,'empty.jpg');
...
CREATE TABLE `whosays` (
  ...
  `saytime` datetime DEFAULT CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `check_essayid` CHECK (regexp_like(`essayid`,_utf8mb4'^1[0-9]{8}$'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `whosays` VALUES ('000000001','100000001','今天碰到了钢铁猪猪侠，真开心！','2024-03-22 14:00:05','whosays/essayt3.jpg'),('000000002','100000002','今天碰到了无敌暴龙战士，真开心！','2024-03-22 14:08:05','whosays/essay1.jpg'),('000000001','100000003','这是一个测试','2024-04-06 14:25:23',''),('000000007','100000004','李灵哲发出了第一个朋友圈','2024-05-10 15:11:22','whosays/essay1.jpg'),('000000008','100000005','大家好，我创建了一个朋友圈。','2024-05-12 16:58:12','whosays/essay1.jpg'),('000000001','100000006','今天碰到了钢铁猪猪侠，真开心！111','2024-03-22 14:00:05','whosays/essayt3.jpg'),('000000001','100000007','今天碰到了钢铁猪猪侠，真开心！','2024-03-22 14:00:05','whosays/essayt3.jpg'),('000000001','100000008','这也是一个测试！','2024-05-18 21:50:45','whosays/essayt3.jpg'),('000000001','100000009','135465','2024-05-21 16:23:53','whosays/2024_5_5 21_36_18.png'),('000000001','100000010','test','2024-05-21 18:33:25','whosays/2024_5_5 21_36_18.png'),('000000008','100000011','我是一只嵩鼠！','2024-05-21 20:40:55','whosays/songshu.jpg'),('000000008','100000012','test','2024-05-21 21:31:43','whosays/2024_5_5 21_36_18.png');
...
-- Dump completed on 2024-05-22  8:30:44
